import qrcode
from tkinter import Tk, Frame, Label, Entry, Button, messagebox, Canvas, filedialog
...
label4 = Label(Frame4, text="Enter size: 1 to 40 (1 = 21x21)", bg="slate blue", fg='azure',
...
button.place(relx=0.20, rely=0.6, relwidth=0.25, relheight=0.06)

# Button to save QR Code
savbutton = Button(wn, text='Save Code', font='Helvetica 9 bold', command=saveCode)
savbutton.place(relx=0.55, rely=0.6, relwidth=0.25, relheight=0.06)
